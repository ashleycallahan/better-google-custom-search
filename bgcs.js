...
var betterGoogleCustomSearchOptions = {
    searchResultsUrl: 'index.html',
    searchId: 'cse-search-form',
    searchResultsId: 'cse-search-results-form'
};
var betterGoogleCustomSearch = function() {
    
    // Google brand statement
    var googleBrand = "Google™ Custom Search";
    
    // Prettify options
    for(var prop in betterGoogleCustomSearchOptions) this[prop] = betterGoogleCustomSearchOptions[prop];
